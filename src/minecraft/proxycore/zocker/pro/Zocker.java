...
import minecraft.proxycore.zocker.pro.storage.cache.memory.MemoryCacheEntry;
import minecraft.proxycore.zocker.pro.storage.cache.memory.MemoryCacheEntryBuilder;
...
public class Zocker {
	...
	public Zocker(ProxiedPlayer player) {
	...
	public static Zocker getZocker(ProxiedPlayer player) {
		if (player == null) return null;
