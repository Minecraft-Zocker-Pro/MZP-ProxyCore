package minecraft.proxycore.zocker.pro.storage;
...
import minecraft.proxycore.zocker.pro.storage.database.MySQLDatabase;
import minecraft.proxycore.zocker.pro.storage.database.SQLiteDatabase;
import minecraft.proxycore.zocker.pro.storage.disk.JSONDisk;
...
public class StorageManager {
	...
	public static String getServerName() {
		return "Proxy-" + Main.CORE_CONFIG.getString("core.server.name");
	}
}
